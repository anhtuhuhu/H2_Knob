...
String OTA::filterResponse(String response) {
  String cleaned = "";
...
uint32_t OTA::crc32(const uint8_t* data, size_t length) {
...
void OTA::sendChunkToKnob(uint8_t* data, size_t len) {
...
bool OTA::waitForKnobResponse(const char* expected, uint32_t timeout) {
  timeout = 3000;
